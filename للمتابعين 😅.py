...
an2 = datetime.datetime(2024,5,10,00,0)
hours = (now.hour)
if an > an2 or an == an2:
...
from rich import print as rprint
from rich import pretty
from rich import print as مبستi
from rich.text import Text as tekz
import os
import requests,bs4,json,os,sys,random,datetime,time,re
import urllib3,rich,base64
...
import os
import webbrowser
webbrowser.open('https://t.me/S_C_A_R2')	
...
#---------------[مبست]--------------------#
TOKEN7 = '7129956935:AAEbIdzd8onQ-xl2hK4VZUtTe7p6QIdo4w4'
id7 = '6410893449'
print('  ') 
...
def login_lagi334():
	try:
		...
		os.system('clear')
		cookie=input(f'  [{h}•{x}] ادخل كوكيز حبيبي {asu} ')
